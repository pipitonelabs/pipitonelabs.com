...
Here's something I'm pretty proud of. My blog uses Vercel's adapter locally (for easy development), but I needed to switch to a standalone Node adapter for Kubernetes. Instead of maintaining two different config files, I used sed during the build:
...
That was a cool experiment and was extremely time consuming to figure out!
